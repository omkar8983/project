...
function callpoll() {
    ...
    (function () {
        ...
        function createQuestionElement(index) {
           ...
           // qElement.append(header);
            ...
            var question = $('<p class="question-holder">').append(questions[index].question);
            ...
            if (array1[0] == "Result of ") {
               // $("#redot").show();
                ...
                for (var i = 0; i < questions[index].choices.length; i++) {
					...
					if(array2[0]!="nooption1" && array2[0]!="nooption2"&& array2[0]!="nooption3" && array2[0]!="nooption4")
					{
                    //input = '<label style="width: 25%;word-wrap: break-word;">';
                        input = '<label class="bg-label" style="width: 99%;word-wrap: break-word;">';
                    input += array2[0] + '</label>';
                        ...
                        input += ' <label style="width:99%;"> <p style="     margin: 0px;font-size: 11px;   padding: 5px 0px 0px;height: 6px; width:' + array2[1] +'; background-color:#03c2bb;     color: #070e18;">';
					...
					if(questions[index].choices[i]!="nooption1" && questions[index].choices[i]!="nooption2" && questions[index].choices[i]!="nooption3" && questions[index].choices[i]!="nooption4")
                    {
                       // input = '<label class="question-label"><input type="radio"  name="answer" value=' + i + ' style="opacity:0" /><span>';
                        //input += questions[index].choices[i] + '</span></label>';
                         ...
                         input = '<input type="radio"  name="answer"  id=' + i + '  value=' + i + ' style="opacity:1" />';
                         input += '<label class="question-label" for=' + i +'> ' + questions[index].choices[i] + "</label>";
        ...
        function quizend() {
            ...
            $('#question').remove();
            $('#quiz-time-left').hide();
            quiz.append('<h4 style="text-align: center;">Thank you for participating</h4>').fadeIn();
            polldone = "1";
            questionCounter = 0;
            selections = [];
	...
	*/
    ...
    function savepoll(ans) {
       ...
       var obj =    {
            "name": "seema",
            "email": "padalkar@gmail.com",
            "Eventid": "24FDEvent_1027",
            "Question": "myquestion",
            "Answer": "selected Ans"
     ...
     //   obj.ans = ans;
        ...
        $.ajax({
            type: "POST",
            url: "https://eventsapi.24fd.com/PollAnswer/AddPollAnsData",
